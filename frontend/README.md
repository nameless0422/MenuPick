...
로그인(카카오/구글) ~ 세션 복원, 메뉴 관리 화면(US-2: 목록 무한스크롤·등록·수정·삭제·태그 자동완성·선호도·추천 제외)까지 구현됐다. 식당/픽/히스토리 페이지는 자리만 잡아둔 상태(TODO 주석 참고) — [Requirements.md](../docs/Requirements.md)의 유저 스토리(US-3~US-5) 기준으로 채워나가면 된다.
